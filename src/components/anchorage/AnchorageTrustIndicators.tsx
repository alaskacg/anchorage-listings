...
const AnchorageTrustIndicators = () => {
  const indicators = [
    {
      icon: Shield,
    ...
    },
    {
      ...
      description: "Built by Anchorage locals, for Anchorage locals",
    },
    {
      icon: Building2,
      title: "Metro Focus",
      description: "Covering all Greater Anchorage neighborhoods",
    },
    {
      icon: CheckCircle,
...
export default AnchorageTrustIndicators;
