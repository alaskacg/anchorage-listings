      ...
      <div className="relative container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-muted-foreground text-lg mb-12 max-w-2xl mx-auto">
            Reach thousands of Anchorage residents looking for exactly what you're selling. No commissions, no hidden fees—just a simple $10 flat rate.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-glass rounded-2xl p-6 text-center">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-secondary/30 mb-4">
...
export default AnchorageCTASection;
