    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-24 pb-20">
        <div className="container mx-auto px-4">
          <h1 className="font-display text-3xl font-bold text-foreground mb-8">Manage Listings</h1>
          <p className="text-muted-foreground">Admin listings management coming soon.</p>
        </div>
      </main>
      <AnchorageFooter />
    </div>
...
export default AnchorageAdminListings;
